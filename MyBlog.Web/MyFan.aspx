<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyFan.aspx.cs" Inherits="MyFan" %>
...
<body>
    <%--  --%>
    <table class="layui-hide" id="fanTable" lay-filter="test"></table>
    ...
    <script>
        layui.use(['table', 'jquery'], function () {
            ...
            table.render({
                elem: '#fanTable'
                , height: 444//高度
                , id: 'fanTable'//表格id，搜索功能重载表格需要使用
                , url: '/Comm/ApiGetFan.ashx'//接口
                ...
                , cols: [[
                    ...
                    , { field: 'UserId', title: '粉丝Id', width: 120, fixed: 'left', unresize: true, sort: true }
                    , { field: 'UserName', title: '粉丝', width: 120 }
