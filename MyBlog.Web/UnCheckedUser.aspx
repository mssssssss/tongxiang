<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnCheckedUser.aspx.cs" Inherits="CheckUser" %>
...
<body>
    ...
    <script type="text/html" id="barDemo">
        ...
        <a class="layui-icon layui-icon-survey layui-btn layui-btn-danger layui-btn-xs" lay-event="check">审核</a>
    </script>
        ...
        layui.use(['table', 'jquery'], function () {
            ...
            table.on('tool(test)', function (obj) {
                ...
                if (obj.event == 'detail') {
                    ...
                    layer.confirm('确认通过用户' + data.UserName + '的学生认证?', function (index) {
                        $.ajax({
                            type: "post",
                            async: true,
                            url: "Comm/ApiUpdateUser.ashx",
                            data: { userId: data.UserId, checkStatus: "1" },
