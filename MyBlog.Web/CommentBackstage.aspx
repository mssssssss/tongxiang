        ...
        layui.use(['table', 'jquery'], function () {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    , { field: 'UserName', title: '评论人', width: 120}
                    , {
                        field: 'CmtContent', title: '评论内容', width: 200, templet: function (res) {
                            return '<em>' + res.CmtContent + '</em>'
                        }
                    }
                    , { field: 'CmtTime', title: '评论时间', width: 200, sort: true }
            ...
            table.on('tool(test)', function (obj) {
                var data = obj.data;
                if (obj.event == 'detail') {
                    var comContent = data.CmtContent;
                    layer.open({
                        title: "用户" + data.UserName + '给你评论说'
                        , content: comContent
                    });
