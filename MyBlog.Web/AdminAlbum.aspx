<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminAlbum.aspx.cs" Inherits="AdminAlbum" %>
        ...
        layui.use(['table', 'jquery'], function () {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    , { field: 'CityPicId', title: '照片ID', width: 120, fixed: 'left', unresize: true, sort: true }
                    , { field: 'ProvinceId', title: '省份ID', width: 120, sort: true }
                    , { field: 'ProvinceName', title: '省份名', width: 180 }
                    , {
                        field: 'CityPicUrl', title: '轮播照片', width: 90, templet: function (res) {
                            return '<img src=' + res.CityPicUrl + '>';
                        }
                    }
            ...
            table.on('tool(test)', function (obj) {
                ...
                //console.log(obj)
                if (obj.event === 'del') {
                    layer.confirm('真的删除照片:' + data.CityPicUrl + '?', function (index) {
                        $.ajax({
                            type: "post",
                            async: true,
                            url: "/Comm/ApiDeleteCityPic.ashx",
                            data: { CityPicId: data.CityPicId },
            ...
            var $ = layui.$, active = {
                reload: function () {
                    ...
                    table.reload('photoTable', {
                        url: '/Comm/ApiFuzzyCityPic.ashx'//模糊查询接口，默认是table.render中的url
